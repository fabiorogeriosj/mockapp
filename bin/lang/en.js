...
module.exports = {
    ...
    START_BUILD_AND_RUN_APP: "Starting build and run app...".green,
    ...
    START_IMPORT_BASEAPP: "Downloading app base...".green,
    START_INSTALL_SERVICE_APP: "Installing service...".green,
    ...
    BUILD_AND_RUN_SUCCESS: " Cool! ".bgGreen.black + " Build and run successfully app :)",
    ...
    APP_IMPORTED_SUCCESS: " Cool! ".bgGreen.black + " Base app successfully imported :)",
    ...
    IMPORT_BASEAPP_FAILED: " Ops! ".bgRed.white + " Unable to import base app :(",
    ...
    PLATFORM_NOT_INFORMED_RUN: " Ops! ".bgRed.white + " You must enter the platform, eg mockapp run android.",
    ...
    BUIDING_AND_RUNING_APP: "Building and running app...",
    ...
    TYPE_NOT_FOUND_INSTALL: " Ops! ".bgRed.white + " You must tell what will install the app.",
    ...
    NAME_NOT_FOUND_INSTALL_SERVICE: " Ops! ".bgRed.white + " You must inform the name of service to install.",
    ...
    PARAMS_INCORRECT_INSTALL_SERVICE: " Ops! ".bgRed.white + " Service name was reported incorrectly, eg: \nmockapp install service camera",
    ...
    SERVICE_INSTALL_SUCCESS: function(obj){
      ...
      console.log("Path:", PATH_SERVICES + obj.serviceFile.yellow);
      console.log("Add the service to your controller like the example below :");
      console.log("HomeController.$inject = ['$scope', '".yellow+obj.name.yellow+"']; ");
    },
