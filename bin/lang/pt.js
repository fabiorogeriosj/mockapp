...
module.exports = {
    ...
    SERVICE_INSTALL_SUCCESS: function(obj){
      ...
      console.log("Caminho:", PATH_SERVICES + obj.serviceFile.yellow);
      console.log("Adicione o serviço no seu controller como o exemplo abaixo :");
      console.log("HomeController.$inject = ['$scope', '".yellow+obj.service.yellow+"']; ");
    },
